...
const AboutSection = () => {
  return (
    <section id="about" className="py-16 md:py-24 relative overflow-hidden bg-pulp-yellow/5">
      <div className="absolute inset-0 bg-gradient-radial from-pulp-yellow/10 to-transparent" aria-hidden="true" />
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {hosts.map((host) => (
            <div key={host.name} className="bg-black border-4 border-pulp-yellow transform hover:scale-[1.02] transition-all duration-300">
