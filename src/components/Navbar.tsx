...
const Navbar = () => {
  ...
  return <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-pulp-red/90 backdrop-blur-md shadow-md' : 'bg-transparent'}`}>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 bg-slate-950">
      ...
      {/* Mobile menu */}
      {isMenuOpen && <div className="md:hidden bg-pulp-red border-b border-pulp-yellow/20">
