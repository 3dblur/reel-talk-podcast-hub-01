  ...
  return (
    <nav 
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled ? 'bg-pulp-red/90 backdrop-blur-md shadow-md' : 'bg-transparent'
      }`}
    >
        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center">
            <a href="/" className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold tracking-tight text-pulp-yellow pixel-text-subtitle" style={{ fontFamily: "'VT323', monospace" }}>JUMP KITCHEN</span>
            </a>
          </div>
