      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="flex flex-col items-center justify-center mb-12">
          <div className="flex items-center mb-4">
            ...
            <h2 className="text-4xl md:text-5xl font-pixel text-white">
              <span className="text-purple-500">@</span>pulpkitchen
            </h2>
          </div>
          <p className="text-gray-300 text-lg md:text-xl text-center max-w-2xl font-pixel">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {reels.map((reel) => (
            <div 
              key={reel.id}
              className="group relative block overflow-hidden rounded-xl transition-all duration-300 hover:scale-[1.02] hover:shadow-lg bg-black/30 border border-purple-500/20"
            >
              <a 
                href={reel.videoUrl}
                target="_blank"
              ...
              >
                <div className="aspect-[9/16] w-full relative">
                  ...
                  <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-purple-500/70 rounded-full p-4 opacity-0 group-hover:opacity-100 transition-opacity">
